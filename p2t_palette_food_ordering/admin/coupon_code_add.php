   ...
   <div class="card categories mb-3 border-0 shadow-sm">
      <nav aria-label="breadcrumb">
         <ol class="breadcrumb mb-0 p-3">
            ...
            <li class="breadcrumb-item fs-7 fw-semi-bold active">Add Coupon Code</li>
         </ol>
      </nav>
   </div>
      ...
      <div class="card-body">
         <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
               ...
               <h3 class="mb-0 ms-2 fw-bold">Add Coupon Code</h3>
            </div>
         ...
         <form method="post">
            <div class="mb-3">
               ...
               <input type="text" class="form-control" id="CouponCode" name="coupon_code" value="<?php echo oldMessage('coupon_code')?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" id="CouponValue" name="coupon_value" value="<?php echo oldMessage('coupon_value')?>">
            </div>
            <div class="mb-3">
               <label for="CartMinValue" class="form-label fs-7 fw-semi-bold">Cart Min Value</label>
               <input type="text" class="form-control" id="CartMinValue" name="cart_min_value" value="<?php echo oldMessage('cart_min_value')?>">
            </div>
            <div class="mb-3">
               <label for="Date" class="form-label fs-7 fw-semi-bold">Expired On</label>
               <input type="date" class="form-control" id="Date" name="expired_on" value="<?php echo oldMessage('expired_on')?>">
            </div>
